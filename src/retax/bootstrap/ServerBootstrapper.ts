...
import { IServerBootstrapConfig } from './interfaces';
...
export default class ServerBootstrapper extends ABootstrapper<IRetaxConfig, IServerBootstrapConfig, Promise<string>> {
  constructor(
  ...
  public async bootstrap({ req, isomorphicTools }: IServerBootstrapConfig): Promise<string> {
